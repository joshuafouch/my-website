...
<div class="flex flex-col justify-center items-center text-center px-4 py-8">
  <div class="mb-8">
    <h1 class="text-6xl md:text-7xl font-bold italic">Joshua Couch</h1>
  </div>
  ...
  <div class="max-w-2xl mx-auto">
    <h2 class="text-3xl font-semibold mb-4">the bee movie script</h2>
