...
>
  <h1 class="font-title text-3xl p-5">The Declaration of Independence</h1>
  <p>
  ...
  <p>
    ...
    of their public Records, for the sole purpose of fatiguing them into compliance with his measures.<br
    />
    ...
    raising the conditions of new Appropriations of Lands.<br />
    ...
    by our laws; giving his Assent to their Acts of pretended Legislation:<br />
    ...
    Inhabitants of these States:<br />
    ...
    in the most barbarous ages, and totally unworthy the Head of a civilized nation.<br />
    He has constrained our fellow Citizens taken Captive on the high Seas to bear Arms against their Country,
    to become the executioners of their friends and Brethren, or to fall themselves by their Hands.<br
    />
