...
<div
  ...
  style="background-image: url(/assets/happy_snow.webp);"
>
  ...
  <div class="hero-content pt-24 text-center text-neutral-content">
    <div class="max-w-md">
      ...
      <p class="font-main mb-5 text-lg text-accent">
        Here are some of my professional, personal, and academic projects I have produced over
        the years. Most of these are GitHub links to the source code.
      </p>
    </div>
  </div>
</div>
